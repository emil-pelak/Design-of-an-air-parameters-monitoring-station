...
int i2c__init( uint16_t bitrateKHz );

// ustawiamy prêdkoœæ na I2C w kHz (standardowa prêdkoœæ to 100 kHz)  i2c_SetBitrate( 100 );
int i2c_SetBitrate( uint16_t bitrateKHz );
