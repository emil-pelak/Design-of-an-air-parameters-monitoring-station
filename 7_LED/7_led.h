...
#ifndef _7_led_h		// dyrektywy zabezpieczaj¹ce przed wielokrotnym do³¹czaniem
#define _7_led_h		// tego samego pliku nag³ówkowego jeœli bêdzie do³¹czany
...
#define 	LED_ANODY 	PORTA	// port z pod³¹czonymi anodami- 4 bity najm³odsze
